...
**结构型模式：**适配器模式⭐、装饰器模式⭐⭐、享元模式、代理模式⭐⭐、外观模式、组合模式、桥接模式

**行为型模式：**责任链模式、命令模式、中介者模式、观察者模式⭐、状态模式、策略模式⭐、模板模式⭐、备忘录模式、迭代器模式、解释器模式、访问者模式
...
​	抽象工厂模式是围绕一个超级工厂创建其他工厂。该超级工厂又称为其他工厂的工厂。它提供了一种创建对象的最佳方式。
...
​	**它提供了一种创建对象的最佳方式。**一个类负责创建自己的对象，同时确保只有单个对象被创建。这个类提供了一种访问其唯一的对象的方式，可以直接访问，不需要实例化该类的对象。
...
<img src="C:/Users/10275/AppData/Roaming/Typora/typora-user-images/image-20220921195813522.png" alt="image-20220921195813522"  />
...
![image-20220921203145295](https://raw.githubusercontent.com/LifeSum12/typora-image/main/img/202209212031372.png)
...
<img src="https://raw.githubusercontent.com/LifeSum12/typora-image/main/img/202209212035804.png" alt="image-20220921203557728" style="zoom:80%;" />
...
![image-20220921204418696](https://raw.githubusercontent.com/LifeSum12/typora-image/main/img/202209212044773.png)
...
![image-20220921210252386](https://raw.githubusercontent.com/LifeSum12/typora-image/main/img/202209212102470.png)
...
**如何解决：**将这些通用算法抽象出来。在抽象类实现，其他步骤在子类实现。

![image-20220921210620189](https://raw.githubusercontent.com/LifeSum12/typora-image/main/img/202209212106266.png)
