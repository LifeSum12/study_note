在线文档 https://www.yuque.com/atguigu/springboot/na3pfd

![image-20220729210025095](https://raw.githubusercontent.com/LifeSum12/typora-image/main/img/202207292100332.png)
...
虽然我们127个场景的所有自动配置启动的时候默认全部加载，但是`xxxxAutoConfiguration`按照条件装配规则（`@Conditional`），最终会 
...
public class ParameterTestController {
    ...
    public Map<String,Object> getCar(@PathVariable("id") Integer id,
                                     ...
                                     @ReQquestHeader("User-Agent") String userAgent,
